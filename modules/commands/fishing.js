    ...
    switch (handleReply.type) {
        ...
        case "buyShop": {
            try {
                ...
                if (userData.money < itemUserChoose.price) return api.sendMessage("[Fishing Shop] mày có tiền đéo đâu mà mua cần câu mới", event.threadID, event.messageID);
        ...
        case "upgradeSlot": {
            try {
                ...
                if (userData.money < moneyOfUpgrade) return api.sendMessage(`[Fishing Shop] mày đéo có tiền để có thể mua thêm chỗ cho túi đồ, bạn còn thiếu khoảng ${moneyOfUpgrade - userData.money}`, event.threadID, event.messageID);
