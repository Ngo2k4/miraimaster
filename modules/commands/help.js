...
module.exports.run = function({ api, event, args, client, __GLOBAL }) {
	...
	if (!command) {
		...
		return api.sendMessage(msg + `[ Sử dụng: "${(threadSetting.hasOwnProperty("PREFIX")) ? threadSetting.PREFIX : __GLOBAL.settings.PREFIX}help từng lệnh ở trên" để xem chi tiết cách sử dụng! | Hiện tại đang có ${client.commands.size} lệnh có thể sử dụng trên bot này. Bot có vấn đề gì xin liên hệ Admin\nAdmin:https://www.facebook.com/dungkon2002/ ]`, event.threadID);
